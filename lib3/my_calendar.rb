...
class MyCalendarService
  ...
  SERVICE_ACCOUNT_EMAIL = 'my-calendar@level-night-145910.iam.gserviceaccount.com'
  CLIENT_SECRET_PATH = Rails.root.join('.credentials', 'My Project-a6d4bc18f2b3.p12').to_s
